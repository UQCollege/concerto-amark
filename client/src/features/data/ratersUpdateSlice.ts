...
export type RaterList = { raterName: string; firstName?:string; lastName?:string; raterDigitalId: string; userType: string; active: boolean; totalTasks?: number; className?:number}; 
